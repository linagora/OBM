...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\icassomaj on
     Windows, /home/user/dev/icassomaj on Linux) in a file named
     icassomaj@nicolas.lascombes and copy that file to
