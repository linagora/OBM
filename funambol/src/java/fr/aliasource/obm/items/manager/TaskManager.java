 ...
 * 
 */
public class TaskManager extends ObmManager {

	private TodoClient binding;
	...
	public TaskManager(String obmAddress) {

		TaskLocator calendarLocator = new TaskLocator();
		binding = calendarLocator.locate(obmAddress.replace("/Task", ""));
	}
