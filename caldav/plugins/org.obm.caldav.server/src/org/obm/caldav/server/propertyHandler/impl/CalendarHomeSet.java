 ...
 * 
 * Purpose: Identifies the URL of any WebDAV collections that contain calendar
 * collections owned by the associated principal resource.
 * 
 ...
 * 
 * Description: The CALDAV:calendar-home-set property is meant to allow users to
 * easily find the calendar collections owned by the principal. Typically, users
 * will group all the calendar collections that they own under a common
 * collection. This property specifies the URL of collections that are either
 * calendar collections or ordinary collections that have child or descendant
 * calendar collections owned by the principal.
 * 
 * Definition: <!ELEMENT calendar-home-set (DAV:href*)>
 * 
 * Example: <C:calendar-home-set xmlns:D="DAV:"
 ...
 * 
 */
public class CalendarHomeSet extends DavPropertyHandler implements
