 ...
 * PROPFIND allprop request (as defined in Section 14.2 of [RFC4918]).
 * 
 * Description: This property is needed for a client to determine where the
 * scheduling Inbox collection of the current user is located so that processing
 * of scheduling messages can occur.
 * 
 ...
 * 
 */
public class ScheduleInboxURL extends DavPropertyHandler implements
	...
	public void appendPropertyValue(Element prop, Token t, DavRequest req,
		...
		appendElement(elem, "href", NameSpaceConstant.DAV_NAMESPACE_PREFIX)
				.setTextContent("/" + t.getLoginAtDomain() + "/events/inbox");
	}
