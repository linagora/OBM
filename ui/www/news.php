...
<div class="center">
  ...
  <div align="center">
    ...
    <ul class="detailList">
      ...
      <li>
        <div align="left"><b>2005-04-20</b> : New OBM site : <a href="http://obmpro.aliacom.fr/">OBM Professional services</a> (in french for now) online
        </div>
        <br />
      </li>

      <li>
        <div align="left"><b>2005-04-20</b> : version <b>0.8.11</b> released (minor fixes)
        <ol>
          <li> new criteria in List module
          <li> new displayed fields in Contact and List
          <li> Fixes in Import, Company, Contact, List and Referential modules
        </ol>
        </div>
        <br />
      </li>
      ...
      <li>
        <div align="left"><b>2005-02-18</b> : version <b>0.8.10</b> released (minor fixes)
        <ol>
          <li> Many fixes in List module
          <li> Fixes in Time management navigation
          <li> Search by Status corrected in Deal module
        </ol>
        </div>
        <br />
      </li>
      ...
      <li>
        <div align="left"><b>2005-01-05</b> : version <b>0.9</b> started. OBM version 0.8 now on a maintenance only branch (no more BD changes)
        </div>
        <br />
      </li>
