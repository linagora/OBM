...
<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td colspan="2">初步计划从<?php echo $start; ?>到<?php echo $end; ?>(地点: <?php echo $location; ?>)的约会<?php echo $title; ?>
已经被删除。</td>
    </tr>
    <tr>
        <td colspan="2">
          <strong>NB : </strong>如果您正在使用Thunderbird扩展或ActiveSync，您必须同步以查看此删除操作。
        </td>
    </tr>
</table>
