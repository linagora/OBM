...
//Created by
//Attendee(s)
//If you're using the Thunderbird extension or ActiveSync, you must synchronize to view this appointment.
//Details
******************************************************************************/
...
<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td colspan="2"><strong>您被邀请参加此约会</strong></td>
    </tr>
    <tr>
        <td style="text-align:right;width:20%;padding-right:1em;">主题</td><td style="font-weight:bold;"><?php echo $title; ?></td>
    </tr>
    <tr>
        <td style="text-align:right;padding-right:1em;">从</td><td style="font-weight:bold;"><?php echo $start; ?></td>
    </tr>
    <tr>
        <td style="text-align:right;padding-right:1em;">到</td><td style="font-weight:bold;"><?php echo $end; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="text-align:right;" colspan="2">
          <a href="<?php echo $host; ?>calendar/calendar_index.php?action=detailconsult&calendar_id=<?php echo $id; ?>">细节</a>
        </td>
    </tr>
</table>
