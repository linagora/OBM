...
<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
      <td colspan="2">
		<?php echo $target; ?>已经<?php echo $targetState; ?>了以下事件:
      </td>
    </tr>
        <tr>
    ...
    <tr>
        <td style="text-align:right;padding-right:1em;">时间</td><td style="font-weight:bold;"><?php echo $start; ?></td>
    </tr>
    <tr>
        <td style="text-align:right;padding-right:1em;">组织者</td><td style="font-weight:bold;"><?php echo $organizer; ?></td>
    </tr>
    <tr>
		<td style="text-align:right;padding-right:1em;">评论</td><td style="font-weight:bold;"><?php echo $targetComment; ?></td>
	</tr>
    <tr>
