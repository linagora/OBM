...
初步计划是从<?php echo $old_start; ?>到<?php echo $old_end; ?>, (地点: <?php echo $old_location; ?>)的<?php echo $target; ?>资源预订
将被更改为从<?php echo $start; ?>到<?php echo $end; ?>, (地点: <?php echo $location; ?>).
</td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
        <td style="text-align:right;" colspan="2">
          <a href="<?php echo $host; ?>calendar/calendar_index.php?action=detailconsult&calendar_id=<?php echo $id; ?>">要接受或拒绝此更新</a>
        </td>
    </tr>
</table>
