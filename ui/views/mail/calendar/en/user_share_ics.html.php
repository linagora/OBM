...
<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td style="text-align:right;" colspan="2">
          <a href="<?php echo $host; ?>calendar/calendar_render.php?action=ics_export&externalToken=<?php echo $token; ?>&lastname=<?php echo urlencode($name); ?>&firstname=<?php echo urlencode($firstname); ?>&email=<?php echo urlencode($email); ?>">Import ical</a>
        </td>
    </tr>
</table>
