...
đã được cập nhật và sẽ diễn ra từ <?php echo $start; ?> đến <?php echo $end; ?>, (địa điểm : <?php echo $location; ?>, Người tham dự : <?php echo $attendees; ?>).


:: Để chấp nhận bản cập nhật này:
