...
<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    <tr>
        <th style="text-align:center; background-color: #509CBC; color:#FFF; font-size:14px" colspan="2">
          Hủy việc đặt chỗ tài nguyên
        </th>
    </tr>
    <tr>
        <td colspan="2">Đặt chỗ tài nguyên <?php echo $target; ?> ban đầu dự kiến vào ngày <?php echo $start; ?> đến <?php echo $end; ?> (Địa điểm: <?php echo $location; ?>), đã bị hủy.</td>
    </tr>
    <tr>
      <td colspan="2">
