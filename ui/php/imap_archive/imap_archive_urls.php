...
class ImapArchiveUrls {
  ...
  public static function treatments($domainUuid) {
  	return self::domainBasedUrl($domainUuid).self::TREATMENT_PATH;
  }

  public static function nextTreatment($domainUuid) {
  	return self::treatments($domainUuid)."/next";
  }

  public static function logs($domainUuid, $runId) {
  	return self::treatments($domainUuid)."/".$runId."/logs/";
  }
}
?>
