...
function get_campaign_params() {
  ...
  foreach ($params as $k => $v) {
    if (preg_match('/^data-.*-([0-9]+)$/', $k, $matches)) {
...
function get_campaign_action() {
  ...
  $actions['campaign']['add_list_target'] = array (
    ...
    'Url'      => "$path/list/list_index.php?action=ext_get_ids&amp;popup=1&amp;ext_title="
      ...
      .$params['campaign_id']."&amp;ext_target=$lang[l_listess]",
    'Popup'    => 1,
  ...
  if (isset($params['campaign_id'])) {
    ...
    if (!$params['campaign_q']) {
      ...
      if ($params['campaign_q']->f('campaign_status') != $c_campaign_status_enum['finished'])
        $actions['campaign']['archive']['Condition'] = array('none');
    	
      if ($params['campaign_q']->f('campaign_status') != $c_campaign_status_enum['archived'])
...
///////////////////////////////////////////////////////////////////////////////
function update_campaign_action() {
