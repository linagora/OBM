...
\begin{itemize}
\item SurAffaire, qui est une entité permettant le regroupement des affaires
\item Projets, résultant de l'affaire
\item Contrats, générés via cette affaire
\item Facture, liées à l'affaire
\item Document
\end{itemize}
...
\item Particpants : aux responsables technique et commercial de l'affaire
