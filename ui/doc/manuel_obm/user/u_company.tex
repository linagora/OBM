...
La recherche avancée est une recherche ne tenant pas compte de divers caracères (par exemple la recherche d'''edf'' trouvera ``E.D.F'', ou la recherche de ``lautre'' trouvera ``l'autre'') par l'utilisation du champ ``Aussi connue comme''.
