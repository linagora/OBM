...
De nombreux attribus permettent de décrire une société.
Afin de couvrir des utilisations diverses plusieurs attribus peuvent être désactivés et ne pas apparaître dans l'application.
...
Les attribus suivant peuvent être désactivés si non utiles dans une installation d'OBM, et ainsi ne pas apparaître dans l'application :
...
Les catégories peuvent être organisées hiérarchiquement (avec une profondeur de 3 niveaux) par exemple :\\
...
\hline
Chercher & Recherche multicritères et avancée des sociétés \\
\hline
...
\item date de mise à jour (avant / après)
\item Participant
\end{itemize}
...
La recherche avancée est une recherche ne tenant pas compte de divers caracères (par exemple la recherche d'''edf'' trouvera ``E.D.F'', ou la recherche de ``lautre'' trouvera ``l'autre'').
...
Ceci est particulièrement utile lorsque une société déjà existante est créée à nouveau.
