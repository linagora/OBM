...
Il est possible d'inclure les incidents archivées dans les résultats de recherche.
...
Pour insérer l'incident saisie, il faut cliquer sur le bouton ``Enregistrer l'incident''.
...
Ce menu permet supprimée l'incident.
