...
Ce module \incident est  utilisée seulement par le module Contrat.
...
\hline
Type de solution & categorie où on retrouve les types des solutions qui ont ete inseres dans le module administration\\
\hline
Priorite & categorie où on retrouve les priorites qui ont ete inserées dans le module administration\\
\hline
Etat & categorie où on retrouve les etats qui ont ete inserés dans le module administration\\
\end{tabular}
...
\hline
Nouveau & Créer un nouveau incident\\
\hline
...
Cet écran est aussi accessible depuis les résultats de recherche ou les liens depuis d'autres modules en cliquant sur l'incident sélectionné, ou immediatement apres l'insertion du nouveau incident.
