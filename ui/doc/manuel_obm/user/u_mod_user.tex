...
Lorsque \obm est couplé à \aliamin, la gestion ds utilisateurs est déléguée à \aliamin dont c'est le rôle et qui propose une gestion plus riche et étendue.
...
\obm peut s'intégrer à \aliasuite qui propose une authentification SSO (Single Sign On) ou authentification unique pour diverses appliactions.
