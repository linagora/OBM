...
Le module \project comporte 11 sous-menus :
...
\hline
Affectation & Assigner des participants aux différentes tâches du projet\\
\hline
Avancement & Actualiser l'état d'avancement des différentes tâches pour chaque participant au projet\\
\hline
...
\item Une tâche parente est indiquée mais possède des affectations (possible uniquement si affectations créés en même temps)
\item La tâche est transformée en parent (Il n'y a pas de tâche parente indiquée) et la tâche comporte des allocations (ou saisies)
\end{itemize}
