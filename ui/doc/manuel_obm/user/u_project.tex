...
Nom & Nom du projet \\
\hline
Catégorie & Catégorie du projet. On distingue les catégories de tâches facturées (projets clients) des tâches non facturées (projets internes). Les catégories de tâches sont gérées depuis le module Affaire (catégorie d'affaire).\\
\hline
...
Un projet facturé est créé depuis l'affaire commerciale ayant aboutit à ce projet.
