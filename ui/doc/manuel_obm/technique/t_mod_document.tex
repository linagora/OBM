...
La racine de l'arborescence des documents sur le serveur est spécifiée par le paramètre de configuration \variable{\$document\_path}.\\
...
\begin{tabular}{|l|c|l|}
 ...
 \hline
  123 & 3 & \$document\_path/3/123 \\ 
 \hline
  4 & 4 & \$document\_path/4/4 \\ 
 \hline
  12156 & 6 & \$document\_path/6/12156 \\ 
 \hline
\end{tabular}
...
\hline
\$document\_path & /var/www/obmdocuments & Racine du dépôt de document sur disque \\
\hline
