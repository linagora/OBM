...
\subsubsection{Problématique ``AND NOT'' ou exclusions avec liaisons n-n}
...
Ces lignes ne génèrent pas des lignes de critères classiques, mais des lignes d'exclusion en rajoutant dans la clause WHERE de la requête générée des sous-requêtes du type : ``AND contact\_id NOT IN (SELECT ... critères ...)''.

Une ligne de critère est traitée comme exclusion lorsque :
\begin{itemize}
