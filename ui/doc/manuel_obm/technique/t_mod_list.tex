...
Ces lignes sont traitées de façon spéciale dans la clause WHERE, pour ne pas tenir compte de la chaine d'opérateurs logiques, en les combinant avec une AND a l'ensemble des criteres, afin que l'exclusion soit effective peu importe ou est placée la ligne de critères.
