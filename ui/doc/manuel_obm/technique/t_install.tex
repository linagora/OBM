\section{Installation pas à pas d'OBM 1.2.x}

Cette documentation est valide pour la version 1.2.0. Seules les
...
répertoire \fichier{scripts/1.2}.
...
\fichier{scripts/1.2/install\_obmdb\_1.2.mysql.sh} (ou
\fichier{scripts/1.2/install\_obmdb\_1.2.pgsql.sh}) pour changer la
...
Le script \fichier{install\_obmdb\_1.2.mysql.sh} gère les différentes
...
caractères latin1, éditez le fichier \fichier{scripts/1.2/postgres-pre.sql}
...
Le script \fichier{install\_obmdb\_1.2.pgsql.sh} gère toutes les
