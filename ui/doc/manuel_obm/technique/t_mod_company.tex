...
Table des catégories d'entreprise. Une entreprise peut être reliée à plusieurs catégories.\\
...
Table de liaison entre les entreprises et les catégories d'entreprise.\\
...
\hline
\_company\_id & int 8 & Référence à l'entreprise & \\
\hline
\end{tabular}
