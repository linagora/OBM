...
\hline
ext\_get\_id & Affiche sans bandeau, en popup, la recherche des entités du module, permet d'effectuer des recherches et de renvoyer l'entité sélectionnée en cliquant dessus à une url \\
\hline
...
Depuis le module \deal, on sélection la création d'une nouvelle affaire. Une fenêtre externe popup de recherche de société s'ouvre.\\
