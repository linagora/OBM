...
\begin{tabular}{|c|p{9cm}|}
 ...
 \hline
 <viewmonth> & Cette action affiche une vue de l'état de la saisie pour un mois. Elle permet de visualiser les partise du mois pour lesquelles la gestion des temps a été remplie.\\ 
 \hline
  <globalview> & Cette action affiche un écran qui permet de visualiser l'état de remplissage de la gestion des temps pour tous les utilisateurs. Il est possible de valider le mois pour les personnes qui ont entièrement rempli le mois. \\ 
 \hline
