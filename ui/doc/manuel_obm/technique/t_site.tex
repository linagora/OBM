...
\hline
\hline
\multicolumn{3}{c}{\textbf{Paramètres globaux}}\\
\hline
\hline
...
\hline
\hline
\multicolumn{3}{c}{\textbf{Paramètres spéciques aux modules}}\\
\hline
\hline
...
\hline
\hline
\multicolumn{3}{c}{\textbf{Paramètres d'affichage des sections, modules et champs}}\\
\hline
\hline
...
\item Les droits d'accès à chaque section
...
\paragraph{Définition des urls et droits d'accès}

Pour chaque section il est possible de déclarer 2 paramètres, l'url et le droit d'accès; exemple pour la section ``com'' (définition de \$cgp\_show[``section''][``com'']) :\\
...
\hline
right & \$cright\_read & Droits d'accès nécessaire pour l'affichage de la section \\ 
\hline
\end{tabular}
...
$cgp_show["section"]["admin"]["right"] = "$cright_read";
\end{verbatim}
