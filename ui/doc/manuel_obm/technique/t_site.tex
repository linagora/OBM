...
\hline
\$login\_javascript\_header & en-tête javascript à positionner dans head (<head></head>) \\
\hline
\$login\_form\_header & en-tête du formulaire d'authentification\\
\hline
\$login\_form\_login & champ de login\\
\hline
\$login\_form\_password & champ de mot de passe\\
\hline
\$login\_form\_domain & champ de domaine\\
\hline
\$login\_form\_values & autres champs à positionner (nécessaires à OBM)\\
\hline
\$login\_error\_msg & message d'erreur si présent\\
\hline
\end{tabular}
\vspace{0.3cm}
