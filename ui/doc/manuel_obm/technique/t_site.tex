...
\paragraph{Remarque} Le droit d'accès à cune section est défini dans les profils.\\
...
$cgp_hide["company"]["companytype"] = true;            // type
$cgp_hide["company"]["companyactivity"] = true;        // secteur d'activité
$cgp_hide["company"]["companynafcode"] = true;         // code NAF
$cgp_hide["company"]["companycategory1"] = true;       // catégorie
...
\begin{verbatim}
// Contact module
$cgp_hide["contact"]["contactfunction"] = true;   // fonction
$cgp_hide["contact"]["contact_title"] = true;     // titre
$cgp_hide["contact"]["responsible"] = true;       // responsible
$cgp_hide["contact"]["contactcategory1"] = true;  // catégorie 1
$cgp_hide["contact"]["contactcategory2"] = true;  // catégorie 2
$cgp_hide["contact"]["contactcategory3"] = true;  // catégorie 3
$cgp_hide["contact"]["contactcategory4"] = true;  // catégorie 4
$cgp_hide["contact"]["contactcategory5"] = true;  // catégorie 5
...
\begin{verbatim}
// Company module
$cgp_hide["deal"]["dealcategory1"] = true;                 // catégorie
\end{verbatim}  
...
\hline
\multirow{2}{2cm}{contact} & \multirow{2}{2cm}{contactfunction} & list\_contact & function\_label \\ 
\cline{3-4}
