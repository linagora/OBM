...
\begin{tabular}{|l|c|p{9.5cm}|}
 ...
 \hline
  [``group\_ids''] & sel\_group\_id & Groupes sélectionnés (formulaire rdv) \\ 
 \hline
  [``sel\_user\_id''] & sel\_ent[``user''] & Utilisateurs sélectionnés \\ 
 \hline
  [``sel\_resource\_id''] & sel\_ent[``resource] & Ressources sélectionnées \\ 
 \hline
\end{tabular}
...
\item Affichage liste utilisateurs : visible; sélection = [user]
...
\item Affichage liste utilisateurs : visible (selon groupe); sélection = [user]
\item Groupe sélectionné : inchangé 
\end{itemize}
\\ 
...
\item[-] [resource] = vide
\item Affichage calendriers : contenu de [user]
\item Affichage liste utilisateurs : visible du groupe; sélection = [user]
\item Group sélectionné : le groupe sélectionné
\end{itemize}
\\ 

\hline
Sélection ``Tout le monde'' (desselection d'un groupe)
&
\begin{itemize}
\item[-] [user] = [user]
\item[-] [group] = vide
