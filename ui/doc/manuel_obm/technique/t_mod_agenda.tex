...
Qaund un group est sélectionné, la vue passe automatiquement en vue membres du groupe, et le choix des utilisateurs est limité au groupe (restreint à ceux qui ont donné les droits en lecture).

Règles utilisées pour la sélection et le stockage en session des entités :\\

Les entités sélectionnées sont stockées dans le tableau \variable{\$cal\_entity\_id} qui comprend plusieurs entrées :
\begin{itemize}
...
&
\begin{itemize}
\item Session inchangée
\item Affichage calendriers  : contenu de [user], [resource] 
\item Affichage liste utilisateurs : visible; sélection = contenu de [user] 
\item Group sélectionné : ? 
\end{itemize}
\\ 

\hline
Sélection de 1 ou plusieurs utilisateurs en mode vue
&
\begin{itemize}
...
\item[-] [resource] = vide
\item Affichage calendriers : contenu de [user] 
\item Affichage liste utilisateurs : visible du groupe; sélection = contenu de [user] 
\item Group sélectionné : Le groupe
\end{itemize}
\\ 
...
\item[-] ``total\_user'' = [user] + users fournis par [group], limité à \#nb
\item Affichage calendriers  : contenu de ``total\_user'', [resource] 
\item Affichage liste utilisateurs : visible; sélection = ``total\_user'' 
\item Group sélectionné : ? 
\end{itemize}
\\
