...
\subsubsection{Les zones graphiques définies dans le thème standard}
...
\subsubsection{Les objets graphiques définis}
...
\hline
\multirow{4}{3cm}{dernière visite} & last & Block contenant les entités dernièrement visitées\\
\cline{2-3}
 & lastTitle & Titre du block \\
\cline{2-3}
 & lastList & éléments de la liste des entités visitées \\
\hline
...
\hline
\multirow{7}{3cm}{résultat de recherche} & result & Block contenant un résultat de recherche\\
\cline{2-3}
