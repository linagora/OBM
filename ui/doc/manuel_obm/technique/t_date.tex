...
A noter que la fonction javascript globale \fonction{check\_date()} permet aussi de saisir les dates au format du pays (JJ/MM/AAAA ou MM/JJ/AAAA). Cette fonction est définie dans le fichier de langue \fichier{check\_date.js}\\
\hline
