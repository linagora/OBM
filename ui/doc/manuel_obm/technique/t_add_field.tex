...
emacs scripts/0.8/update_0.8.1-0.8.2.pgsql.sql
   \end{verbatim}
 \item (module\_index.php) Récolter le paramètre issu du formulaire (get\_param\_module)\\
 \item Si champ sélection d'une liste déroulante :
    \begin{itemize}
     ...
     \item[*] (module\_query.php) Implémenter les fonctions run\_query\_fieldname(), run\_query\_fieldname\_insert(), run\_query\_fieldname\_update(), run\_query\_fieldname\_delete(), run\_query\_fieldname\_links().
      \begin{verbatim}
