...
\begin{tabular}{|c|p{9cm}|}
 ...
 \hline
  <check_delete> & Vérification avant suppression du projet. \\
 \hline
  <delete> & Suppression du projet. \\
 \hline
  <task> & Affiche le formulaire permettant l'ajout de tâches au projet et la liste des tâches déjà existantes. \\
 \hline
  <member> & Affiche la liste des participants au projet et leurs statuts respectifs. \\
 \hline
 ...
 \hline
  <member\_update> & Change le statut (chef de projet/simple participant) et affiche la liste des participants au projet et leurs statuts respectifs. \\
 \hline
...
\begin{tabular}{|c|c|l|}
 ...
 \hline
  <progress> & project\_write & Droits d'Administrateur en ecriture. \\
 \hline
...
\begin{tabular}{|c|c|p{3cm}|}
 ...
 \hline
 <a\_update> & run\_query\_progress() \\ 
             & run\_query\_statlog() \\ 
             & run\_query\_detail() \\ 
 	     & run\_query\_tasks() \\
	     & run\_query\_members() \\
