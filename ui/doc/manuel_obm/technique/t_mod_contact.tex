...
Le module \contact dispose de 5 tables ContactCategorieLink identiques à celle-ci faisant référence à 5 types de catégorie différentes paramétrable via l'interface d' ''Administration '' et que l'on peut masquer.\\  
