...
\hline
level & Niveau du profil. Un administrateur ou utilisateur ne peut pas créer / modifier / supprimer un utilisateur de privilège plus élevé (niveau 0 = privilège maximum). Si le niveau est pair, il est possible de gérer des utilisateurs de même niveau, sinon non \\ 
\hline
