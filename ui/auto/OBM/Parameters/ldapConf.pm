...
@ISA = qw(Exporter);
@EXPORT_const = qw( $ldapAdminLogin $POSIXUSERS $POSIXGROUPS $SAMBAUSERS $SYSTEMUSERS $NODE $ROOT $DOMAINROOT $SAMBADOMAIN $SAMBAFREEUNIXID $SAMBAGROUPS $SAMBAHOSTS $POSTFIXCONF $MAILSHARE $GROUPOFNAMES );
