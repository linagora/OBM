...
sub getDomains {
    ...
    my $queryDomain = "SELECT domain_id, domain_label, domain_description, domain_name, domain_alias, samba_value FROM P_Domain LEFT JOIN P_Samba ON samba_name=\"samba_sid\" AND samba_domain_id=domain_id";
