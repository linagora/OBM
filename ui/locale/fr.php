...
return array(
  ...
  'ACCEPTED' => 'accepté',
  'DECLINED' => 'refusé',
  'New event created by %sender% on OBM: %title%' => 'Nouvel événement de %sender% sur OBM : %title%',
  'Event cancelled by %sender% on OBM: %title%' => 'Evénement annulé par %sender% sur OBM : %title%',
  ...
  'Resource reservation cancelled on OBM: %title%' => 'Annulation d\'une réservation de ressource sur OBM : %title%',
  'New resource reservation on OBM: %title%' => 'Nouvelle réservation de ressource sur OBM : %title%',
