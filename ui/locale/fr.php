...
return array(
  ...
  'ACCEPTED' => 'accepté',
  'DECLINED' => 'refusé',
  'New event created by %sender% on OBM: %title%' => '%sender%, Nouvel événement de %sender% sur OBM : %title%',
  'Event cancelled by %sender% on OBM: %title%' => '%sender%, Evénement annulé par %sender% sur OBM : %title%',
  'Event updated by %sender% on OBM: %title%' => '%sender%, Mise à jour d\'un événement par %sender% sur OBM : %title%',
  'New resource reservation on OBM: %title%' => 'Nouvelle réservation de ressource sur OBM : %title%',
  'Resource reservation updated on OBM: %title%' => 'Mise à jour d\'une réservation de ressource sur OBM : %title%',
  'New resource reservation on OBM: %title%' => 'Nouvelle réservation de ressource sur OBM : %title%',
