...
return array(
  ...
  'ACCEPTED' => 'accepté',
  'DECLINED' => 'refusé',
  'New event created by %sender%: %title%' => 'Nouvel événement de %sender% : %title%',
  'Event cancelled by %sender%: %title%' => 'Evénement annulé par %sender% : %title%',
  'Event updated by %sender%: %title%' => 'Mise à jour d\'un événement par %sender% : %title%',
