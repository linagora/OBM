...
return array(
    "events from this ics could not be imported" => "Les évènements de cet ics n'ont pas pu être importés",
    "Couldn't find an obm-sync server for this domain" => "Aucun serveur obm-sync trouvé pour le domaine courant",
