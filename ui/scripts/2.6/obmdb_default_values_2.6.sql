...
INSERT INTO ObmInfo (obminfo_name, obminfo_value) VALUES ('db_version', '2.5.0');
...
-- Global ADMIN
INSERT INTO UserObm (userobm_domain_id, userobm_login, userobm_password, userobm_password_type, userobm_perms, userobm_lastname, userobm_firstname, userobm_uid, userobm_gid, userobm_ext_id) VALUES ((SELECT domain_id From Domain), 'admin0','admin','PLAIN','admin', 'Admin Lastname', 'Firstname', '1000', '512', UUID());
INSERT INTO Entity (entity_mailing) VALUES (TRUE);
