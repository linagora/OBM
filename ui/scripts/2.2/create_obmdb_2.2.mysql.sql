...
CREATE TABLE `Account` (
  ...
  `account_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ActiveUserObm` (
  ...
  `activeuserobm_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `CV` (
  ...
  `cv_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Category` (
  ...
  `category_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Company` (
  ...
  `company_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `CompanyActivity` (
  ...
  `companyactivity_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `CompanyNafCode` (
  ...
  `companynafcode_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `CompanyType` (
  ...
  `companytype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Contact` (
  ...
  `contact_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ContactFunction` (
  ...
  `contactfunction_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Contract` (
  ...
  `contract_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ContractPriority` (
  ...
  `contractpriority_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ContractStatus` (
  ...
  `contractstatus_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ContractType` (
  ...
  `contracttype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Country` (
  ...
  `country_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DataSource` (
  ...
  `datasource_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Deal` (
  ...
  `deal_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DealCompany` (
  ...
  `dealcompany_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DealCompanyRole` (
  ...
  `dealcompanyrole_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DealStatus` (
  ...
  `dealstatus_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DealType` (
  ...
  `dealtype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Document` (
  ...
  `document_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `DocumentMimeType` (
  ...
  `documentmimetype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Domain` (
  ...
  `domain_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Event` (
  ...
  `event_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `EventAlert` (
  ...
  `eventalert_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `EventCategory1` (
  ...
  `eventcategory1_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `EventLink` (
  ...
  `eventlink_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `EventException` (
  ...
  `eventexception_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Host` (
  ...
  `host_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Import` (
  ...
  `import_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Incident` (
  ...
  `incident_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `IncidentPriority` (
  ...
  `incidentpriority_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `IncidentResolutionType` (
  ...
  `incidentresolutiontype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `IncidentStatus` (
  ...
  `incidentstatus_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Invoice` (
  ...
  `invoice_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Kind` (
  ...
  `kind_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Lead` (
  ...
  `lead_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `LeadSource` (
  ...
  `leadsource_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `LeadStatus` (
  ...
  `leadstatus_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `List` (
  ...
  `list_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `MailServer` (
  ...
  `mailserver_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `MailShare` (
  ...
  `mailshare_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `OGroup` (
  ...
  `ogroup_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `OGroupLink` (
  ...
  `ogrouplink_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `OrganizationalChart` (
  ...
  `organizationalchart_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `P_UGroup` (
  ...
  `group_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `P_UserObm` (
  ...
  `userobm_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  ...
  `userobm_timelastaccess` timestamp NOT NULL default CURRENT_TIMESTAMP,
  ...
  `userobm_calendar_version` timestamp NOT NULL default CURRENT_TIMESTAMP,
  ...
  `userobm_mail_login_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `userobm_nomade_perms` int(1) default '0',
  `userobm_nomade_enable` int(1) default '0',
  `userobm_nomade_local_copy` int(1) default '0',
  `userobm_nomade_datebegin` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `userobm_nomade_dateend` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `userobm_email_nomade` text default '',
  `userobm_vacation_enable` int(1) default '0',
  `userobm_vacation_datebegin` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `userobm_vacation_dateend` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ParentDeal` (
  ...
  `parentdeal_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Payment` (
  ...
  `payment_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `PaymentInvoice` (
  ...
  `paymentinvoice_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Profile` (
  ...
  `profile_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Project` (
  ...
  `project_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ProjectClosing` (
  ...
  `projectclosing_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `projectclosing_userupdate` int(8) default NULL,
  `projectclosing_usercreate` int(8) default NULL,
  `projectclosing_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ProjectRefTask` (
  ...
  `projectreftask_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ProjectTask` (
  ...
  `projecttask_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `ProjectUser` (
  ...
  `projectuser_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  ...
  `projectuser_validity` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Publication` (
  ...
  `publication_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `PublicationType` (
  ...
  `publicationtype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `RGroup` (
  ...
  `rgroup_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Region` (
  ...
  `region_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Resource` (
  ...
  `resource_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `Subscription` (
  ...
  `subscription_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  ...
  `subscription_date_begin` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `subscription_date_end` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `SubscriptionReception` (
  ...
  `subscriptionreception_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `TaskType` (
  ...
  `tasktype_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `TimeTask` (
  ...
  `timetask_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `timetask_userupdate` int(8) default NULL,
  `timetask_usercreate` int(8) default NULL,
  `timetask_user_id` int(8) default NULL,
  `timetask_date` timestamp NOT NULL default CURRENT_TIMESTAMP,
...
CREATE TABLE `UserObm_SessionLog` (
  ...
  `userobm_sessionlog_timecreate` timestamp NOT NULL default CURRENT_TIMESTAMP,
