...
psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.0~1.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.2~1.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.2~2.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.2~3.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.2~4.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.2~5.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.1/updates/update-3.1.6~1.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.2/updates/update-3.2.0~1.pgsql.sql" >> /tmp/data_insert.log 2>&1
