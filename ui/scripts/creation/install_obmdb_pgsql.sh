...
psql -U ${user} -h ${host} ${db} -f \
  "../3.0/updates/update-3.0.1~1.pgsql.sql" >> /tmp/data_insert.log 2>&1

psql -U ${user} -h ${host} ${db} -f \
  "../3.0/updates/update-3.0.1~2.pgsql.sql" >> /tmp/data_insert.log 2>&1
...
psql -U ${user} -h ${host} ${db} -f \
  "../3.0/updates/update-3.0.1~5.pgsql.sql" >> /tmp/data_insert.log 2>&1
