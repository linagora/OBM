...
public class CalendarBindingImplTest {
	...
	public void testGetCalendarMetadata() throws ServerFault, FindException {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao, rightsHelper, null, null, attendeeService, null, null);
	...
	public void testGetResourceMetadata() throws FindException, ServerFault {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService,
				calendarDao, null, commitedOperationDao, null, null, null, attendeeService, null, null);
	...
	public void testImportEventInThePast() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao,
				null, commitedOperationDao, rightsHelper, ical4jHelper, calendarFactory, attendeeService, null, null);
	...
	public void testPurge() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(eventChangeHandler, null, userService, calendarDao, null, commitedOperationDao, rightsHelper, null, null, attendeeService, null, null);
	...
	public void testCommentResettedOnChangeParticipationState() throws SQLException {
		...
		CalendarBindingImpl calendarBindingImpl = new CalendarBindingImpl(null, null, null, calendarDao, null, commitedOperationDao, null, null, null, attendeeService, null, null);
	...
	public void testImportEventInTheFuture() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao,
				rightsHelper, ical4jHelper, calendarFactory, attendeeService, null, null);
	...
	public void testModifyNullEvent() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, null, null, null, null, null, null, null, attendeeService, null, null);
	...
	public void testModifyNotExistingEvent() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao, null, null, null, attendeeService, null, null);
	...
	public void testAttendeeHasRightToWriteOnCalendar() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(eventChangeHandler, null, userService, calendarDao, null, commitedOperationDao, helper, null, null, attendeeService, null, null);
	...
	public void testAttendeeHasNoRightToWriteOnCalendar() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(eventChangeHandler, null,
				userService, calendarDao, null, commitedOperationDao, helper, null, null, attendeeService, null, null);
	...
	private Event testParseICS(EventExtId extId, Event eventFromDao) throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao, helper, ical4jHelper, calendarFactory, attendeeService, null, null);
	...
	private EventChanges mockGetSyncWithSortedChanges(String calendar, String userName,
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao, rightsHelper, null, null, attendeeService, anonymizerService, configurationService);
	...
	public void testCreateUnauthorizedEventOnCalendar() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService, calendarDao, null, commitedOperationDao, helperService, null, null, attendeeService, null, null);
	...
	public void testCreateInternalEvent() throws EventNotFoundException, ServerFault, FindException, SQLException {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(eventChangeHandler, null, null, calendarDao, null, commitedOperationDao, null, null, null, attendeeService, null, null);
	...
	public void testChangePartipationStateNoRightsOnAttendees() {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, null, null, null, null, noRightsHelper, null, null, attendeeService, null, null);
	...
	public void testChangeParticipationHasRightOnOneAttendee() {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, null, null, null, null, rightsHelper, null, null, attendeeService, null, null);
		calendarService.assignDelegationRightsOnAttendees(accessToken, after);
		calendarService.applyParticipationModifications(before, after);
	...
	public void testNegativeExceptionChange() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(eventChangeHandler, null,
				userService, calendarDao, null, commitedOperationDao, rightsHelper, null, null, attendeeService, null, null);
	...
	public void testReadOnlyCalendarWithPrivateEventsIsAnonymized() throws Exception {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, userService,
				calendarDao, null, commitedOperationDao, rightsHelper, null, null, attendeeService, anonymizerService, configurationService);
	...
	public void testAssertEventCanBeModifiedWhenCannotWriteOnCalendar() throws Exception {
		...
		CalendarBindingImpl calendarService =
				new CalendarBindingImpl(null, null, null, null, null, null, helperService, null, null, attendeeService, null, null);
	...
	public void testInheritsParticipationForSpecificAttendee() {
		...
		CalendarBindingImpl calendarService =
				new CalendarBindingImpl(null, null, null, null, null, null, null, null, null, attendeeService, null, null);
	...
	public void testGetResourceEvents() throws ServerFault, FindException {
		...
		CalendarBindingImpl calendarService = new CalendarBindingImpl(null, null, null, mockDao,
				null, null, null, null, null, attendeeService, null, null);
	...
	public void testCreateInternalEventConvertsAttendees() throws Exception {
		...
		CalendarBindingImpl binding = new CalendarBindingImpl(eventChangeHandler, null, userService, calendarDao, null, commitedOperationDao, helperService, null, null, attendeeService, null, null);
	...
	public void testImportICSCachesAttendeeLookups() throws Exception {
		...
		CalendarBindingImpl binding = new CalendarBindingImpl(eventChangeHandler, domainService, userService, calendarDao, categoryDao, commitedOperationDao, helperService, ical4jHelper, calendarFactory, attendeeService, null, null);
		UserAttendee userAttendee = UserAttendee.builder().email(calendar).build();
		UserAttendee organizerAttendee = UserAttendee.builder().email("organizer@test.tlse.lng").build();
