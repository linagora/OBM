...
public class CheckBoxStateTest {
	...
	@Test
	public void testFromValue0() {
		assertThat(CheckBoxState.fromValue(0)).isEqualTo(CheckBoxState.UNCHECKED);
	}

	@Test
	public void testFromValue1() {
		assertThat(CheckBoxState.fromValue(1)).isEqualTo(CheckBoxState.CHECKED);
	}
	...
	public void testFromValueInvalidValue() {
		CheckBoxState.fromValue(666);
	}
