...
public class ParticipationService {
	...
	@VisibleForTesting boolean changeOnEvent(final AccessToken token, final EventExtId extId,
	...
	@VisibleForTesting boolean changeOnOccurrence(final AccessToken token, final EventExtId extId,
