<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td colspan="2">Le rendez-vous ${old.subject}, initialement prévu du ${old.start?string.medium_short} au ${old.end?string.medium_short}, (lieu : ${old.location}), a été modifié :</td>
    </tr>
    <tr>
