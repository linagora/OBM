...
a été modifié et se déroulera du ${new.start} au ${new.recurrenceEnd} de ${new.startTime} à ${new.endTime}, (lieu : ${new.location}, type de récurrence : ${old.recurrenceKind}).
