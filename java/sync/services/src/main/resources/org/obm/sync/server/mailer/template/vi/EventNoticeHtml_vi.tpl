<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td colspan="2">Bạn đã được mời để tham gia cuộc hẹn này </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="text-align:right;padding-right:1em;">Đến</td><td style="font-weight:bold;">${end}</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="text-align:right;" colspan="2">
          <a href="${host}calendar/calendar_index.php?action=detailconsult&calendar_id=${calendarId}">Chi tiết</a>
        </td>
    </tr>
</table>
