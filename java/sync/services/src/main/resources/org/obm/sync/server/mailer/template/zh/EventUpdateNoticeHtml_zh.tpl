<table style="width:80%; border:1px solid #000; border-collapse:collapse;background:#EFF0F2;font-size:12px;">
    ...
    <tr>
        <td colspan="2">
初步计划从${old.start}到${old.end}(地点: ${old.location})的约会${new.subject}已更新: </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="text-align:right;padding-right:1em;">到</td><td style="font-weight:bold;">${new.end}</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td colspan="2">
      		<strong>NB : </strong>如果您正在使用Thunderbird扩展或ActiveSync，您必须同步以查看此更新。
    	</td>
	</tr>
    <tr>
