...
public class ObjectStoreManagerMigrationTest extends StoreManagerConfigurationTest {
	...
	private ObjectStoreManagerMigration opushCacheManager;
	private Logger logger;

	public ObjectStoreManagerMigrationTest() {
		super();
	}
	...
	public void init() throws IOException {
		...
		this.opushCacheManager = new ObjectStoreManagerMigration(super.initConfigurationServiceMock(), logger);
	}
