...
public class MonitoredCollectionDaoEhcacheMigrationImplTest extends StoreManagerConfigurationTest {
	...
	public void testGetKeys() {
		...
		monitoredCollectionStoreServiceMigrationImpl.store.put(new Element(
				key, 
				ImmutableSet.of(AnalysedSyncCollection.builder()
						.collectionId(1)
		...
		List<Object> keys = monitoredCollectionStoreServiceMigrationImpl.getKeys();
	...
	public void testGet() {
		Element element = new Element(
				...
				ImmutableSet.of(AnalysedSyncCollection.builder()
					...
					.syncKey(new SyncKey("123"))
					.build()));
		monitoredCollectionStoreServiceMigrationImpl.store.put(element);
		
		Element value = monitoredCollectionStoreServiceMigrationImpl.get(new Key(credentials, getFakeDeviceId()));
	...
	public void testRemove() {
		...
		monitoredCollectionStoreServiceMigrationImpl.remove(key);
		
		Element value = monitoredCollectionStoreServiceMigrationImpl.get(key);
