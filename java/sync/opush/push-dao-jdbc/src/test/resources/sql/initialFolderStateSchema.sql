...
CREATE TABLE opush_folder_sync_state_backend_mapping (
    ...
    CONSTRAINT opush_folder_sync_state_backend_mappi_folder_sync_state_id_fkey FOREIGN KEY (folder_sync_state_id) REFERENCES opush_folder_sync_state(id) ON DELETE CASCADE
);
