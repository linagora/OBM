...
CREATE TABLE opush_ping_heartbeat (
    ...
    CONSTRAINT unique_opush_ping_heartbeat_col_dev UNIQUE (device_id),
    CONSTRAINT opush_ping_heartbeat_device_id_fkey FOREIGN KEY (device_id) REFERENCES opush_device(id) ON DELETE CASCADE
);
