...
CREATE TABLE opush_event_mapping (
    ...
    CONSTRAINT opush_event_mapping_device_id_event_ext_id_fkey UNIQUE (device_id, event_ext_id_hash),
    CONSTRAINT opush_event_mapping_device_id_fkey FOREIGN KEY (device_id) REFERENCES opush_device(id) ON DELETE CASCADE
);
