...
import org.obm.push.dao.testsuite.FolderSyncStateBackendMappingDaoTest;
	...
	public static class Env extends DaoTestModule {
		...
		protected void configureImpl() {
			...
			bind(DateProvider.class).toInstance(new DateProvider() {
				...
				@Override
				public Date getDate() {
					return dateProviderValues.next();
				}
			});
		}
	}
	
	@Rule public H2InMemoryDatabaseRule dbRule = new H2InMemoryDatabaseRule(this, "sql/initialFolderStateSchema.sql");
