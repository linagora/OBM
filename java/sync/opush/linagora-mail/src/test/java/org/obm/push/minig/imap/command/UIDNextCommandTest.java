...
public class UIDNextCommandTest {
	...
	public void testResponseReceivedNOK() {
		...
		uidNextCommand.responseReceived(Arrays.asList(new IMAPResponse("NO", "")));
	...
	public void testResponseReceived() {
		...
		uidNextCommand.responseReceived(Arrays.asList(response, new IMAPResponse("OK", "")));
	...
	public void testResponseReceivedMultiLines() {
		...
		long expectedUIDNext = 44292;
		uidNextCommand.responseReceived(Arrays.asList(response, response2, new IMAPResponse("OK", "")));
