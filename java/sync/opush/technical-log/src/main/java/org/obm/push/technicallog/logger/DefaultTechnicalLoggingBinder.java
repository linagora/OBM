...
public class DefaultTechnicalLoggingBinder implements ITechnicalLoggingBinder {
	
	private final static Logger logger = LoggerFactory.getLogger(DefaultTechnicalLoggingBinder.class);
	
	@Override
	public void logTransaction(DateTime startTime, DateTime endTime) {
		logger.info("logTransaction called");
	}

	@Override
	public void logRequest(MethodInvocation methodInvocation, DateTime startTime, DateTime endTime) {
		logger.info("logRequest called");
	}

	@Override
	public void logResource(ResourceType resourceType, DateTime startTime, DateTime endTime) {
		logger.info("logResource called");
	}
}
