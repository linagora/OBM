...
public class ImapMoveAPITest {
	...
	@Test
	public void testMoveNonExistingEmailDoNothing() throws Exception {
		Email sentEmail = sendEmailToInbox();
		...
		Set<Email> inboxEmails = mailboxEmails(INBOX);
		Set<Email> movedEmails = mailboxEmails(toMoveEmailMailbox);
		Assertions.assertThat(inboxEmails).hasSize(1);
		Assertions.assertThat(movedEmails).isEmpty();
	}
