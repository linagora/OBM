...
public class BodyPreferencePolicyUtils {

	public static ImmutableList<BodyPreference> bodyPreferences(MSEmailBodyType... emailBodyTypes) {
	...
	public static BodyPreference bodyPreference(MSEmailBodyType emailBodyType) {
