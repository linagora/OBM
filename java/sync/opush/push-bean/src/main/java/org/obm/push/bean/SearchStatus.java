...
public enum SearchStatus {
	...
	private SearchStatus(String specificationValue) {
	...
	public static SearchStatus fromSpecificationValue(String specificationValue){
	...
	private static Map<String, SearchStatus> specValueToEnum;
	
	static {
		Builder<String, SearchStatus> builder = ImmutableMap.builder();
		for (SearchStatus searchStatus : values()) {
			builder.put(searchStatus.specificationValue, searchStatus);
		}
