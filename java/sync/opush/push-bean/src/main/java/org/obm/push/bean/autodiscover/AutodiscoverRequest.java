...
public class AutodiscoverRequest {
	...
	public static class Builder {
		...
		private String acceptableResponseSchema;
		...
		public Builder acceptableResponseSchema(String acceptableResponseSchema) {
			this.acceptableResponseSchema = acceptableResponseSchema;
			return this;
		}
		
		public AutodiscoverRequest build() {
			return new AutodiscoverRequest(emailAddress, acceptableResponseSchema);
		}
	}
	...
	private AutodiscoverRequest(String emailAddress, String acceptableResponseSchema) {
		this.emailAddress = emailAddress;
		this.acceptableResponseSchema = acceptableResponseSchema;
	}
