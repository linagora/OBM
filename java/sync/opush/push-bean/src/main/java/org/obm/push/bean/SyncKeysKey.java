...
public class SyncKeysKey implements Serializable{
	...
	private SyncKeysKey(DeviceId deviceId, int collectionId) {
		this.deviceId = deviceId;
		this.collectionId = collectionId;
	}
	...
	public final int hashCode(){
		return Objects.hashCode(deviceId, collectionId);
	}
	
	@Override
	public final boolean equals(Object object){
		if (object instanceof SyncKeysKey) {
			SyncKeysKey that = (SyncKeysKey) object;
