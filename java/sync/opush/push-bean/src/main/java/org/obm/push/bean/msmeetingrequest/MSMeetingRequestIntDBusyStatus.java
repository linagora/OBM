 ...
 */
public enum MSMeetingRequestIntDBusyStatus {
	...
	private static Map<Integer, MSMeetingRequestIntDBusyStatus> values;
	static {
		Builder<Integer, MSMeetingRequestIntDBusyStatus> builder = ImmutableMap.builder();
		for (MSMeetingRequestIntDBusyStatus type: values()) {
			builder.put(type.asXmlValue(), type);
		}
		values = builder.build();
	}
	
	private MSMeetingRequestIntDBusyStatus(int xmlValue) {
