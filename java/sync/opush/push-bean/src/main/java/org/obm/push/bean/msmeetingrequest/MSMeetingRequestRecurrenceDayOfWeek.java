...
public enum MSMeetingRequestRecurrenceDayOfWeek {
	...
	private static Map<Integer, MSMeetingRequestRecurrenceDayOfWeek> values;
	static {
		Builder<Integer, MSMeetingRequestRecurrenceDayOfWeek> builder = ImmutableMap.builder();
		for (MSMeetingRequestRecurrenceDayOfWeek type: values()) {
			builder.put(type.asXmlValue(), type);
		}
		values = builder.build();
	}
	
	private MSMeetingRequestRecurrenceDayOfWeek(int xmlValue) {
