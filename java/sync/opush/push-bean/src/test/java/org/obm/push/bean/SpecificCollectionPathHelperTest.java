...
public class SpecificCollectionPathHelperTest {
	...
	public void testParseSubSpecificFolderDraftDoesntMatchAsSpecific() throws CollectionPathException {
		...
		String parsedFolder = collectionPathHelper.extractImapFolder(bs, collectionPath, PIMDataType.EMAIL);
		Assertions.assertThat(parsedFolder).isEqualTo(EmailConfiguration.IMAP_DRAFTS_NAME);
	}
	...
	public void testParseSubSpecificFolderSentDoesntMatchAsSpecific() throws CollectionPathException {
		...
		String parsedFolder = collectionPathHelper.extractImapFolder(bs, collectionPath, PIMDataType.EMAIL);
		Assertions.assertThat(parsedFolder).isEqualTo(EmailConfiguration.IMAP_SENT_NAME);
	}
	...
	public void testParseSubSpecificFolderTrashDoesntMatchAsSpecific() throws CollectionPathException {
		...
		String parsedFolder = collectionPathHelper.extractImapFolder(bs, collectionPath, PIMDataType.EMAIL);
		Assertions.assertThat(parsedFolder).isEqualTo(EmailConfiguration.IMAP_TRASH_NAME);
	}
}
