...
public class ContactsBackendTest {
	...
	public void testGetAllChangesOnFirstSync() throws Exception {
		...
		expect(mappingService.getServerIdFor(collectionId, String.valueOf(contact.getUid())))
			.andReturn("1:" + contact.getUid()).once();
		expect(mappingService.getServerIdFor(collectionId, String.valueOf(contact2.getUid())))
