...
public class HierarchyExporterTest {
	...
	public void testFolderChanges() throws Exception {
		...
		ItemChange contactDeleted = new ItemChange("3", contactCollectionId, "DELETED", FolderType.USER_CREATED_CONTACTS_FOLDER, false);
		...
		ItemChange mailDeleted = new ItemChange("3", mailCollectionId, "DELETED", FolderType.USER_CREATED_EMAIL_FOLDER, false);
