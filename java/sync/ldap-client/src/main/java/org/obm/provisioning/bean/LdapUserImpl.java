...
public class LdapUserImpl implements LdapUser {
	...
	public class IdImpl implements LdapUser.Id {
	...
	public static class Builder {
		...
		public LdapUserImpl build() {
			return new LdapUserImpl(configuration.getUserBaseDn(), objectClasses, uid, uidNumber, gidNumber, loginShell,
	...
	private LdapUserImpl(Dn userBaseDn, String[] objectClasses, String uid, int uidNumber, int gidNumber, String loginShell,
	...
	@Override
	public LdapUser.Id getId() {
		return new IdImpl(getUid());
	}
	...
	public final boolean equals(Object object){
		if (object instanceof LdapUserImpl) {
			LdapUserImpl that = (LdapUserImpl) object;
