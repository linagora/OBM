...
public class LdapDomain {
		...
		public static LdapDomain valueOf(String domain) {
			return new LdapDomain(domain);
		}

		private LdapDomain(String domain) {
			this.domain = domain;
		}
		...
		public final boolean equals(Object object){
			...
			return Objects.equal(domain, ((LdapDomain)object).domain);
		}
