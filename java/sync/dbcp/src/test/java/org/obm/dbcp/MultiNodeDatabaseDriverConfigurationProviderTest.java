...
public class MultiNodeDatabaseDriverConfigurationProviderTest {
	...
	private final DatabaseDriverConfiguration mysql2Configuration = new MySQLDriverConfiguration() {
		public boolean readOnlySupported() {return true;}
	};
	private final Set<DatabaseDriverConfiguration> drivers = ImmutableSet.of(postgresConfiguration, mysqlConfiguration, mysql2Configuration);
	...
	public void testConstructorShouldFetchSingleConfiguration() {
		...
		assertThat(new MultiNodeDatabaseDriverConfigurationProvider(drivers, configs).get()).isEqualTo(postgresConfiguration);
	}
	...
	public void testConstructorShouldFetchAnyConfigurationWhenSeveralExist() {
		...
		assertThat(new MultiNodeDatabaseDriverConfigurationProvider(drivers, configs).get()).isIn(mysqlConfiguration, mysql2Configuration);
	}
