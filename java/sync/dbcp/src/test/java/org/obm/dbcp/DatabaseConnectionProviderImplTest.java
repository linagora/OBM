...
public class DatabaseConnectionProviderImplTest {
	...
	private DatabaseDriverConfigurationFactory databaseDriverConfigurationFactory;
	...
	public void setUp() {
		...
		databaseDriverConfigurationFactory = new DatabaseDriverConfigurationFactory(ImmutableSet.<DatabaseDriverConfiguration>of(new PostgresDriverConfiguration()), databaseConfiguration);
	}
	...
	public void testGetConnectionExceptionOnFirstStatement() throws Exception {
		...
		DatabaseDriverConfiguration databaseDriverConfiguration = databaseDriverConfigurationFactory.create();
	...
	public void testGetJdbcObjectWhenH2() throws SQLException {
		...
		databaseDriverConfigurationFactory = new DatabaseDriverConfigurationFactory(ImmutableSet.<DatabaseDriverConfiguration>of(new H2DriverConfiguration()), databaseConfiguration);
	...
	private PoolingDataSourceDecorator poolingDataSource() {
		return new PoolingDataSourceDecorator(databaseDriverConfigurationFactory, databaseConfiguration, logger);
	}
}
