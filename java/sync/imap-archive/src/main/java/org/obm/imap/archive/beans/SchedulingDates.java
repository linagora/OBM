...
public class SchedulingDates {
	...
	@Override
	public int hashCode(){
		return Objects.hashCode(nextTreatmentDate);
	}
	
	@Override
	public boolean equals(Object object){
		if (object instanceof SchedulingDates) {
			SchedulingDates that = (SchedulingDates) object;
			return Objects.equal(this.nextTreatmentDate, that.nextTreatmentDate);
		}
		return false;
	}
