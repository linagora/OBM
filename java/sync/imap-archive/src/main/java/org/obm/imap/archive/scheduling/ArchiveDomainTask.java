...
public class ArchiveDomainTask implements Task {
	...
	private Factory statusChangedFactory;

	public ArchiveDomainTask(ImapArchiveProcessing imapArchiveProcessing,
			TaskStatusChanged.Factory statusChangedFactory,
			ArchiveConfiguration configuration) {
		this.imapArchiveProcessing = imapArchiveProcessing;
		this.statusChangedFactory = statusChangedFactory;
	...
	@Override
	public void run() {
		imapArchiveProcessing.archive(configuration);
	}
	
	public TaskStatusChanged createStatusChangeEvent(ScheduledTask.State state) {
		return statusChangedFactory.create(state, this);
	}
