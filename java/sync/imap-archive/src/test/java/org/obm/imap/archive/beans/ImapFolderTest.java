...
public class ImapFolderTest {
	...
	public void builderShouldThrowWhenNameIsNull() {
		ImapFolder.builder().name(null);
	}

	@Test(expected=IllegalStateException.class)
	public void builderShouldThrowWhenNameNotProvided() {
		ImapFolder.builder().build();
	}
	...
	public void builderShouldBuildWhenEveryThingIsProvided() {
		...
		ImapFolder imapFolder = ImapFolder.builder()
			.name(name)
			.build();
	...
	public void fromShouldBuild() {
		...
		assertThat(ImapFolder.from(name)).isEqualToComparingFieldByField(imapFolder);
	}
}
