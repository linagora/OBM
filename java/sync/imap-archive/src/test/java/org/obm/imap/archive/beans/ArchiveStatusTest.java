...
import static org.obm.imap.archive.beans.ArchiveStatus.WARNING;
...
public class ArchiveStatusTest {
	...
	@Test
	public void warning() {
		assertThat(WARNING.asSpecificationValue()).isEqualTo("WARNING");
		assertThat(fromSpecificationValue("WARNING")).isEqualTo(WARNING);
	}
