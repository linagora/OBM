...
public class EventRecurrenceTest {
	...
	@Test
	public void testAnonymizeWithPublicEventExceptions() {
		Date exceptionDeleted = DateUtils.date("2004-12-14T22:00:00Z");
	...
	public void testAnonymizeWithPrivateMovedExceptions() {
		...
		privateEventException1.setRecurrenceId(DateUtils.date("2004-12-12T22:00:00Z"));
		privateEventException1.setStartDate(DateUtils.date("2004-12-12T21:00:00Z"));
		...
		privateEventException2.setRecurrenceId(DateUtils.date("2004-12-13T22:00:00Z"));
		privateEventException2.setStartDate(DateUtils.date("2004-12-13T21:00:00Z"));
		...
		privateAnonymizedEventException1.setAnonymized(true);
		privateAnonymizedEventException1.setRecurrenceId(DateUtils.date("2004-12-12T22:00:00Z"));
		privateAnonymizedEventException1.setStartDate(DateUtils.date("2004-12-12T21:00:00Z"));
		...
		privateAnonymizedEventException2.setAnonymized(true);
		privateAnonymizedEventException2.setRecurrenceId(DateUtils.date("2004-12-13T22:00:00Z"));
		privateAnonymizedEventException2.setStartDate(DateUtils.date("2004-12-13T21:00:00Z"));
