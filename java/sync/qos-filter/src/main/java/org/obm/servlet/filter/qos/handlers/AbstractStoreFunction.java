...
public abstract class AbstractStoreFunction<K extends Serializable, V> implements StoreFunction<K, V> {

	private final K key;
	
	public AbstractStoreFunction(K key) {
		this.key = key;
	}
