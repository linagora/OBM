...
public class ProvisioningServerService extends ServletModule {

	public static final String GLOBAL_CONFIGURATION_FILE = ConfigurationService.GLOBAL_OBM_CONFIGURATION_PATH;
	public static final String APPLICATION_NAME = "obm-provisioning";
	
	private final ServletContext servletContext;

	public ProvisioningServerService(ServletContext servletContext) {
