...
public enum UserJsonFields {
	...
	ARCHIVED("archived"), HIDDEN("hidden"), MAILS("mails"), EFFECTIVEMAILS("effectiveMails"),
	NOMAD_ENABLED("nomad_enabled"), NOMAD_EMAIL("nomad_mail"), NOMAD_ALLOWED("nomad_allowed"), NOMAD_LOCAL_COPY("nomad_local_copy"),
