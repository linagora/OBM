...
public class PatchGroupJsonDeserializer extends JsonDeserializer<Group> {

	public PatchGroupJsonDeserializer(Group oldGroup) {
	...
	public Group deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
		Group.Builder builder = Group.builder().from(oldGroup);
