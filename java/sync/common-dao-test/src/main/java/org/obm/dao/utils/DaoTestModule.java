...
public abstract class DaoTestModule extends AbstractModule {
	...
	protected void configure() {
		...
		bindConstant().annotatedWith(Names.named("initialSchema")).to(initialSqlSchemaPath());
		configureImpl();
	}
	
	protected abstract void configureImpl();
	protected abstract String initialSqlSchemaPath();
