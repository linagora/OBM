...
public class ObmSyncHttpClientModule extends AbstractModule {
	...
	protected void configure() {
		bind(UserClient.Factory.class);
		bind(BookClient.Factory.class);
		bind(CalendarClient.Factory.class);
		bind(LoginClient.Factory.class);
		bind(MailingListClient.Factory.class);
		bind(SettingClient.Factory.class);
	}
