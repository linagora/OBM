...
public class CommonClientDriverExpectation {

	private ClientDriverRule driver;

	public CommonClientDriverExpectation() {
		driver = new ClientDriverRule();
	}
	
	public ClientDriverRule getClientDriverRule() {
		return driver;
	}
	
	public ClientDriverExpectation expectTrustedLogin(ObmDomainUuid domainId) {
	...
	public ClientDriverExpectation expectGetDomain(ObmDomainUuid domainId) {
		return driver.addExpectation(
