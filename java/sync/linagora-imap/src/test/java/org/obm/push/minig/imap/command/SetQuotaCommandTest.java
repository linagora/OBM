...
public class SetQuotaCommandTest {
	...
	public void testRemoveQuota() {
		assertThat(new SetQuotaCommand("mailboxPath").getImapCommand())
			.isEqualTo("SETQUOTA \"mailboxPath\" ()");
	}
	
	@Test
	public void testRemoveQuotaWithUTF7() {
		assertThat(new SetQuotaCommand("mailboxé").getImapCommand())
			.isEqualTo("SETQUOTA \"mailbox&AOk-\" ()");
	}
