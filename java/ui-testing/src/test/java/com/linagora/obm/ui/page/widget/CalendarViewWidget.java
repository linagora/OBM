...
public class CalendarViewWidget extends CalendarWidget {

	private final WebElement calendarViewElement;
	private WebElement listViewElement;

	public CalendarViewWidget(CalendarPage calendarPage, WebElement calendarViewElement) {
		super(calendarPage);
		this.calendarViewElement = calendarViewElement;
	}

	public boolean isInAgendaView() {
		WebElement currentViewElement = calendarViewElement.findElement(new ByCssSelector("img[title='Vue calendrier, cette vue est éditable']"));
	...
	public void listView() {
		clickAndWait(retrieveListViewElement());
	}
