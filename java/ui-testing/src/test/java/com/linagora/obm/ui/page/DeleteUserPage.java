...
public class DeleteUserPage extends RootPage {
	...
	public void deleteUserByLogin(String userLogin) {
		driver.findElement(By.linkText(userLogin.toLowerCase())).click();
		driver.findElement(By.id("check_delete_user")).click();
		driver.findElement(By.id("delete_user")).click();
		driver.switchTo().alert().accept();

	}

	public boolean deletionSucceeded() {
		try {
			waitAndTestElementPresence(By.name("displayMessageOk"));
			return true;
		}
